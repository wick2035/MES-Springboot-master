            ...
            <div class="layui-row">
                <div class="layui-col-xs6 layui-col-sm6 layui-col-md10">
                    <div class="layui-form-item">
                        <label for="js-teamCode" class="layui-form-label sp-required">班组代码</label>
                        <div class="layui-input-inline">
                            <input type="text" id="js-teamCode" name="teamCode" lay-verify="required" autocomplete="off"
                                   class="layui-input" value="${result.teamCode}">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label for="js-teamName" class="layui-form-label sp-required">班组名称</label>
                        <div class="layui-input-inline">
                            <input type="text" id="js-teamName" name="teamName" lay-verify="required" autocomplete="off"
                                   class="layui-input" value="${result.teamName}">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label for="js-teamDesc" class="layui-form-label">班组描述</label>
                        <div class="layui-input-inline">
                            <input type="text" id="js-teamDesc" name="teamDesc" autocomplete="off"
                                   class="layui-input" value="${result.teamDesc}">
                        </div>
                    </div>
                    <div class="layui-form-item">
